  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-[#070a12]/95 backdrop-blur-md border-b border-cyan-500/20 py-3 shadow-lg shadow-cyan-950/20'
          : 'bg-[#070a12]/80 backdrop-blur-md border-b border-slate-800/40 py-4.5 md:bg-transparent md:border-transparent md:py-5'
      }`}
    >
